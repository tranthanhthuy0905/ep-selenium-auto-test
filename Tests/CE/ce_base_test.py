...
class CEBaseTest(BaseTest):
    ...
    def choose_MI_N_Instance_Type(self):
        ...
        time.sleep(3)
        new_instance = self.launch_instances_wizard_page.choose_instance_details()
        self.instance_name = new_instance.instance_name
    ...
    def launch_instance_01_default_pw(self):
        ...
        #     "Should successfully create an instance by adding default password by running new instance"
        # )
